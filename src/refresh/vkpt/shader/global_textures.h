...
#define LIST_IMAGES \
	...
	IMG_DO(DLSS_OUTPUT,               37, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH_UNSCALED,  IMG_HEIGHT_UNSCALED) \
	IMG_DO(PT_VIEW_DEPTH_SPLIT,       38, R32G32B32A32_SFLOAT, rgba32f, IMG_WIDTH,           IMG_HEIGHT     ) \
	IMG_DO(PT_RAY_LENGTH,             39, R32G32_SFLOAT,       rg32f,   IMG_WIDTH_TAA,       IMG_HEIGHT_TAA ) \
	IMG_DO(PT_DLSS_MOTION,            40, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH_TAA,       IMG_HEIGHT_TAA)  \
	IMG_DO(DLSS_DEPTH,                41, R32G32B32A32_SFLOAT, rgba32f, IMG_WIDTH_UNSCALED,  IMG_HEIGHT_UNSCALED)  \
	IMG_DO(DLSS_RAY_LENGTH,           42, R32G32B32A32_SFLOAT, rgba32f, IMG_WIDTH_TAA,       IMG_HEIGHT_TAA)  \
	IMG_DO(DLSS_TRANSPARENT,          43, R32G32B32A32_SFLOAT, rgba32f, IMG_WIDTH_TAA,       IMG_HEIGHT_TAA)  \
