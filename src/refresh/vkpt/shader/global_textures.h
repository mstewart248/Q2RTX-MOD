...
#define LIST_IMAGES \
	...
	IMG_DO(DLSS_SPECULAR,             49, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH_TAA,		 IMG_HEIGHT_TAA ) \
	IMG_DO(PT_ROUGHNESS,              50, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH,           IMG_HEIGHT     ) \
	IMG_DO(DLSS_ROUGHNESS,            51, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH_TAA,		 IMG_HEIGHT_TAA ) \
	IMG_DO(PT_METALLIC,               52, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH,           IMG_HEIGHT     ) \
	IMG_DO(DLSS_METALLIC,             53, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH_TAA,		 IMG_HEIGHT_TAA ) \
	IMG_DO(PT_NORMAL,                 54, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH,           IMG_HEIGHT     ) \
	IMG_DO(DLSS_NORMAL,               55, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH_TAA,		 IMG_HEIGHT_TAA ) \
	IMG_DO(PT_MATERIALID,             56, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH,           IMG_HEIGHT     ) \
	IMG_DO(DLSS_MATERIALID,           57, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH_TAA,		 IMG_HEIGHT_TAA ) \
	IMG_DO(PT_EMISSIVE,               58, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH,           IMG_HEIGHT     ) \
	...
	IMG_DO(PT_BEFORE_TRANSPARENT,     65, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH,           IMG_HEIGHT     ) \
	IMG_DO(DLSS_BEFORE_TRANSPARENT,   66, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH_TAA,       IMG_HEIGHT_TAA ) \
	IMG_DO(PT_RAYLENGTH_DIFFUSE,      67, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH,           IMG_HEIGHT     ) \
	...
	IMG_DO(DLSS_REFLECTED_ALBEDO,     72, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH_TAA,       IMG_HEIGHT_TAA ) \
